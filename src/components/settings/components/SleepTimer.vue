...
<template>
  <div class="text-text space-y-4">
    ...
    <div class="flex gap-2">
      <button @click="startTimer(10)" class="px-3 py-1 rounded bg-bg-hover hover:bg-bg-hover-light">10
        {{ t('timer_minutes') }}
      </button>
      <button @click="startTimer(30)" class="px-3 py-1 rounded bg-bg-hover hover:bg-bg-hover-light">30
        {{ t('timer_minutes') }}
      </button>
      <button @click="startTimer(60)" class="px-3 py-1 rounded bg-bg-hover hover:bg-bg-hover-light">60
        {{ t('timer_minutes') }}
      </button>
    ...
    <div v-if="showCustom" class="flex items-center gap-2">
      <el-input
          ...
          class="flex-1"
      ></el-input>
      <button class="shrink-0 px-3 py-1 rounded bg-bg-hover hover:bg-bg-hover-light"
